...
import "@openzeppelin/contracts/token/ERC721/ERC721.sol"; // importing a contract that we use for minting
import "@openzeppelin/contracts/access/Ownable.sol"; //allow function definition for the owner
